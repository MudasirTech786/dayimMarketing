...
function Register() {
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-[#1819ab]">
      <div
        className="bg-white min-w-[200px] flex flex-col items-center rounded-lg px-14 py-6 
                      sm:min-w-[500px]"
      >
        <Image
        ...
        <form className="flex flex-col w-full">
          ...
          <label htmlFor="confirm_password" className="text-sm mt-5">
            Confirm Password
          </label>
          <input
            type="password"
          ...
          <button className="bg-[#1819ab] w-full text-white rounded-full p-3 uppercase text-sm mt-5">
            Register
          </button>
